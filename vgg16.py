...
def init_conv(win_h, win_w, n_inputs, n_filters):
    ...
    return tf.constant(conv), tf.constant(biases)
...
class Vgg16:
    ...
    def build(self, input):
        ...
        self.upconv2 = self.upconv_concat(self.conv4_5, self.conv3_3, 256, name='upconv_2')
        ...
        self.upconv3 = self.upconv_concat(self.conv3_5, self.conv2_2, 128, name='upconv_3')
        ...
        self.upconv4 = self.upconv_concat(self.conv2_4, self.conv1_2, 64, name='upconv_4')
        ...
        self.conv1_5 = self.new_conv(self.conv1_4, 1, name='conv1_5')

        self.output = tf.nn.softmax(self.conv1_5)
    ...
    def get_conv_filter(self, name):
        if name == "conv1_1":
            ...
            tens[:, :, :3, :] = old
            tens[:, :, 3:6, :] = old
            return tf.constant(tens, name='filter')
