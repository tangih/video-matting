...
class UNetSmall:
    def __init__(self, input, phase):
        ...
        self.pool1 = tf.nn.max_pool(self.conv1_1, ksize=[1, 2, 2, 1], strides=[1, 2, 2, 1], padding='SAME')
        self.conv2_1 = tf.nn.relu(new_conv(self.pool1, 16, 'conv2_1', phase))
        self.pool2 = tf.nn.max_pool(self.conv2_1, ksize=[1, 2, 2, 1], strides=[1, 2, 2, 1], padding='SAME')
        ...
        self.conv1_3 = new_conv(self.conv1_2, 1, 'conv1_3', phase)
